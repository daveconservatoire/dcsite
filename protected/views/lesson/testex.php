...
<div class="progress progress-striped active success" style="margin:20px">
  <div class="bar" style="width: 0%;"></div>
</div>

<div class="alert alert-success masterymsg" style="display:none">
 <strong>Well done!</strong> You've mastered this skill - time to move on to something new!</strong>
</div>
    ...
    <div id="answer_area_wrap"><div id="answer_area">
        <form id="answerform" name="answerform">
            ...
            <div class="info-box" id="answercontent">
                ...
                <div id="positive-reinforcement"><img src="<? echo bu();?>/img/face-smiley.png" ></div>
