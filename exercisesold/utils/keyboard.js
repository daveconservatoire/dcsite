...
function SoundManager(smURL, smID) {
  ...
  this.noSWFCache = true;           // if true, appends ?ts={date} to break aggressive SWF caching.
...
soundManager.url = 'http://www.daveconservatoire.org/exercises/swf/'; // directory where SM2 .SWFs live
...
if(!soundManager.getSoundById(target)){
soundManager.createSound({ id: target, url: '/exercises/sounds/'+url+'/'+target+'.mp3'});
}
...
setTimeout("playSound(thetarget)", 200);
}
...
soundManager.ontimeout(function(){
  ...
  alert("There was a problem loading SoundManager - sounds may not play correctly.");
...
soundManager.url = 'http://www.daveconservatoire.org/exercises/swf/';
